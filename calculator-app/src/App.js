...
class App extends Component {
  ...
  plusMinusClick = (e) => {
    ...
    this.setState({ displayValue: plusMinus.toString(), plusMinus });
  }
  ...
  render() {
    ...
    let clearButton = <button className="button col-3" onClick={this.handleClearClick} value='0'>AC</button>;
    if (true) {
      clearButton = <button className="button col-3" onClick={this.singleClearClick} value='0'>C</button>;
    }
        ...
        <div className='holder'>
          <div className='calculator'>
            <div className='row'>
              ...
              <button className="button col-3" onClick={this.plusMinusClick}>±</button>
